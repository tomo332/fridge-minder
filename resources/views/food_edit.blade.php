         ...
         @method('put')
            <div class="mt-8">
                <div class="w-full flex flex-col">
                    ...
                    <input type="text" name="food_name" class="w-auto py-2 border border-gray-300 rounded-md" id="food_name" value="{{old('food_name',$post->food_name)}}">
                </div>
                ...
                <div class="w-full flex flex-col">
                    ...
                    <input type="text" name="tag" class="w-auto py-2 border border-gray-300 rounded-md" id="tag" value="{{old('tag', $post->tag)}}">
                </div>
